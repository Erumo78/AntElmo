const CACHE='antelmo-v7.2.2';
const ASSETS=['./','./index.html','./styles.css?v=722','./app.js?v=722','./pro.js?v=722','./photo-dex.js?v=722','./v5.js?v=722','./v6.js?v=722','./v7.js?v=722','./v7-roadmap.js?v=722','./data.json','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
