/* ANTELMO V7.3.3 — ampliaciones que funcionan íntegramente en el dispositivo. */
...
function ensureLocalRoadmapData(){
  ...
  db.metadata={...(db.metadata||{}),schemaVersion:'7.3.3'};
}
...
save=function(){
  ...
  db.metadata.schemaVersion='7.3.3';db.metadata.updatedAt=new Date().toISOString();
